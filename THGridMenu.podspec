#
# Be sure to run `pod spec lint THGridMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name         = "THGridMenu"
  s.version      = "0.0.1"
  s.summary      = "A short description of THGridMenu."
  s.description  = <<-DESC
  ...
  # s.authors      = { "" => "troy.harris@djt-tech.com", "other author" => "and email address" }
  #
  ...
  #
  s.source       = { :git => "https://github.com/troyharris/THGridMenu.git", :tag => "0.0.1" }
